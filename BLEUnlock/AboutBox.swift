...
class AboutBox: NSWindowController, NSWindowDelegate {
    ...
    @IBAction func visitHomepage(_ sender: Any) {
        NSWorkspace.shared.open(URL(string: "https://github.com/SQHOME-Jin/BLEUnlock#readme")!)
    }

    @IBAction func checkReleases(_ sender: Any) {
        NSWorkspace.shared.open(URL(string: "https://github.com/SQHOME-Jin/BLEUnlock/releases")!)
    }
    convenience init() {
