...
This document is also available in [Japanese (日本語版はこちら)](README.ja.md) and [Chinese (中文版)](README.zh-Hans.md).
...
- Customizable unlock delay time (0.5s to 3.0s in 0.5s increments) for better user experience

## Modifications by SQHOME-Jin

This fork includes the following enhancements:

1. Added customizable unlock delay time feature:
   - Default delay set to 0.5 seconds
   - Adjustable range from 0.5 to 3.0 seconds
   - Configurable in 0.5-second increments
   - Provides better control over the unlock timing

2. Updated interface localization:
   - Added Chinese localization for the About interface
   - Maintained original copyright information while adding modification credits
   - Updated homepage and version check links to point to this fork

3. Improved code stability:
   - Enhanced unlock delay menu handling
   - Fixed potential issues with menu item state management
   - Better error handling for unlock delay settings
